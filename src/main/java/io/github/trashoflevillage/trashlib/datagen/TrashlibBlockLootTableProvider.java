...
public abstract class TrashlibBlockLootTableProvider extends FabricBlockLootTableProvider {
    protected TrashlibBlockLootTableProvider(FabricDataOutput dataOutput, CompletableFuture<RegistryWrapper.WrapperLookup> registryLookup) {
